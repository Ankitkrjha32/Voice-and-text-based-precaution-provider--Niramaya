      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+91 9944825489</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-red-500 mr-2 flex-shrink-0" />
                <span className="text-gray-400">manishkumar995582@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()}Niramaya. All rights reserved.
          </p>
